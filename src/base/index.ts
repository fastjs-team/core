...
export function createModule<T extends {[key: string]: any}>(module: () => T): T & FastjsModuleBase {
    return {
        ...module(),
        ...
        setCustomEvent(name: string, func: (module: any, ...args: any[]) => void, setup: boolean = false) {
            this[name] = func;
